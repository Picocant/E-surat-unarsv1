...
@section('content')
    <div class="row">
        <div class="col-lg-5 mx-auto">
            <h3 class="mb-4">Laporan Surat Masuk</h3>
            <h5 class="mb-3">Filter laporan</h5>
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form target="_blank" action="{{ route('report.incoming-letter.print') }}" method="get">
                            <div class="mb-3">
                                <label for="report_priods" class="form-label">Periode</label>
                                <input placeholder="Klik untuk pilih tanggal" readonly type="text" id='report_priods'
                                    class="form-control cs-rounded-1 text-muted">
                                <input type="hidden" name="filterFromDate">
                                <input type="hidden" name="filterToDate">
                            </div>
                            <div class="text-end">
                                <button id="reset-filter-btn" class="btn btn-sm btn-light-primary" type="button">Reset
                                    Filter</button>

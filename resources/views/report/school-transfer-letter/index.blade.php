...
<div class="row">
    <div class="col-lg-5 mx-auto">
        <h3 class="mb-4">Laporan Surat Keterangan Pindah Universitas</h3>
        <h5 class="mb-3">Filter laporan</h5>
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form id="filter-form" target="_blank" action="{{ route('report.school-transfer-letter.print') }}" method="get">
                        <div class="mb-3">

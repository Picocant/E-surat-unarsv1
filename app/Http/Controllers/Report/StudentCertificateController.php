...
class StudentCertificateController extends Controller
{
    ...
    {
        gate('generate-student-certificate-report');

        return view('report.student-certificate.index');
    }
    ...
    public function print(Request $request)
    {
        ...
        $oldest = StudentCertificate::oldest('created_at')->first();
        ...
        return view('report.student-certificate.print', [
            'studentCertificates' => $data->orderBy('created_at', 'ASC')->get(),
            'printBy' => auth()->user(),
